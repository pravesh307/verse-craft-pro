...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Poetic AI Fix enhances a platform to generate poems based on user-provided situations and manage audio playback and payment settings." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Poetic AI Fix enhances a platform to generate poems based on user-provided situations and manage audio playback and payment settings." },
